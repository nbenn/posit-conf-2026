...
::: {.takeaway}
Roughly 100 blocks across a dozen views — one of them written for this app.
:::

::: {.notes}
**A real app — ~45 s** *(105 words)*

We are using blockr at a pharma client to explore clinical data from studies.
...
*The numbers are the evidence. Say them plainly and do not dress them up: a
hundred blocks, a dozen views, one written here.*

*Danger zone — this is where the "look how nice it is" pitch smuggles itself
back in and eats the clock.*
:::
