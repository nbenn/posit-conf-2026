...
::: {.notes}
<!-- What carries over to your next app? — ~73 s (177 words) -->
...
bricks on the other hand is mediated by the studs.
...
**(13) Next are user parameters:** We need a dropdown: The column to join
...
summary tables and visualizations that support drill-down. One block was built
specifically for this use case: the patient explorer.
:::
...
So, that's the five minutes, and we don't get a Q&A. If you have questions, want
to see or hear more, come find me. I would much rather talk to you than to my
laptop.
:::
