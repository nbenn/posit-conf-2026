...
::: {.notes}
**Any shape you want — ~23 s** *(56 words)*
...
::: {.notes}
**What carries over to your next app? — ~69 s** *(165 words)*
...
Well placed restrictions: limiting the shape by defining an interface. That
buys you reuse, and it lets you focus on what matters, humans and current-gen
...
The block is the brick, the link is the stud, the stack is the model. And the
...
::: {.notes}
**Specialty pieces — ~26 s** *(62 words)*

We have been building out a library of general-purpose blocks.

Of course, this will not cover every use case.
