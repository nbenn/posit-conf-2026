...
::: {.notes}
**Any shape you want — ~16 s** *(39 words)*

Play-doh. It's a fun toy: you can create any shape you want with it.

To me personally though, that much freedom felt more like a burden. You don't
get much assistance from the material.
...
::: {.notes}
**What carries over to your next app? — ~70 s** *(169 words)*
...
your attention on the model instead of on the material.
...
::: {.notes}
**A block — ~27 s** *(65 words, +13 s for the optional aside)*
...
stud is our interface: simple, well-defined.
