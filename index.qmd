...
::: {.notes}
<!-- What carries over to your next app? — ~71 s (172 words) -->
...
**(3) Here we have our data inputs.** In this case there are two, `x` and `y`.
...
So, that's the five minutes, and there's no Q&A. If you have questions, want to
see or hear more, come find me. I would much rather talk to you than to my
laptop.
:::
