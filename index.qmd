...
Blocks are not the only extension point. There are *extensions* as well: (1) on
the left, we have a graphical overview of the board and (2) on the right, an AI
assistant.

Most blocks here are general purpose: reading data, transforming it, displaying
summary tables and visualizations that support drill-down. (3) But one block was
